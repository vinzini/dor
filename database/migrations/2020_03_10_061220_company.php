...
class Company extends Migration
{
    ...
    public function up()
    {
        Schema::create('company', function (Blueprint $table) {
            ...
            $table->smallInteger('agree_prescribed_legal_work');
            $table->smallInteger('agree_prescribed_non_legal_work');
            ...
            $table->jsonb('time_slot_wage_weeks');
            ...
            $table->integer('settlement_management_id');
